...
function MaidServiceManagement() {
    ...
    <div className="single-product-area" style={{ paddingTop: '50px' }}>
      ...
      <div className="container">
        <div className="product-bit-title text-center">
          <h2 style={{ color: '#000', paddingTop: '5px' }}>Maid Service Management</h2>
        </div>
        <div className="row">
          {/* Left Sidebar */}
          <div className="col-md-4">
            <div className="single-sidebar">
              <div className="thubmnail-recent">
                ...
                {[
                  'Manage unlimited number of teams',
                  'Print / Email daily schedule',
                  'Automatic Invoice Generation',
                  'Dashboard Notifications',
                  'Customer Data Entry: Prospects, scheduled, Billed',
                  'Inventory Control',
                  'Easy Interface',
              ...
              <div className="single-sidebar">
                ...
                <ul>
                  <li>
                    <Link to="#">Why use software for Maid Service Management?</Link>
                  </li>
                  <li>
          ...
          <div className="col-md-8">
            <div className="product-content-right">
              <div className="product-breadcroumb">
                ...
                <Link to="#">Maid Service Management</Link>
              </div>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="product-images">
                    <div className="product-main-img">
                      <img src="img/product-5.jpg" alt="Main" />
                    </div>
                ...
                <div className="col-sm-6">
                  <div className="product-inner">
                    <h2 className="product-name">For Housekeeping operations management</h2>
                      ...
                      <div className="tab-content">
                        {activeTab === 'home' && (
                          <div role="tabpanel" className="tab-pane active" id="home">
                            ...
                            <p>
                              Coordinating work orders with your employees can be realized using this software. The
                              software runs on a local server and is accessible online as well. Now onwards you won't
                              miss, forget, or misinterpret the work orders. You will know the performance of staff and
                              his work hours.
                            </p>
                            <p>
                              Register, assign work, and take reports on the works assigned from your staff. Make sure
                              the works are going well by looking at the reports. Whether you're a small team with a
                              handful of employees, or a large organization with hundreds of employees/contractors,
                              you and your team members can work more effectively using our software platform.
                            </p>
                          </div>
                        )}
...
export default MaidServiceManagement;
