...
function CentralisedDocumentManagement() {
    ...
    <div className="single-product-area" style={{ paddingTop: '50px' }}>
      ...
      <div className="container">
        <div className="product-bit-title text-center">
          <h2 style={{ color: '#000', paddingTop: '5px' }}>Centralised Document Management</h2>
        </div>
        <div className="row">
          {/* Left Sidebar */}
            ...
            <div className="single-sidebar">
              <div className="thubmnail-recent">
                ...
                {[
                  ...
                  'Empower organizations to capitalize on accumulated knowledge',
                  'Manage digital content',
                  'Manage all the documents of the business',
                  'Set governance & sharing powers',
              ...
              <div className="single-sidebar">
                ...
                <ul>
                  <li>
                    <Link to="#">Why use software for document management?</Link>
                  </li>
                  <li>
          ...
          <div className="col-md-8">
            <div className="product-content-right">
              <div className="product-breadcroumb">
                ...
                <Link to="#">Centralised Document Management</Link>
              </div>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="product-images">
                    <div className="product-main-img">
                      <img src="img/product-6.jpg" alt="Main" />
                    </div>
                ...
                <div className="col-sm-6">
                  <div className="product-inner">
                    <h2 className="product-name">For secure document sharing & storage</h2>
                    <div className="product-inner-category">
                      <p>
                        Tags:{' '}
                        <Link to="#">Document management</Link>,{' '}
                        <Link to="#">Secure sharing</Link>,{' '}
                        <Link to="#">Project / Departmentwise directories</Link>,{' '}
                        <Link to="#">Centralised system for data security</Link>.
                      </p>
                    </div>
                      ...
                      <div className="tab-content">
                        {activeTab === 'home' && (
                          <div role="tabpanel" className="tab-pane active" id="home">
                            ...
                            <p>
                              A Document Management Software is a computer program used to store, manage, and track
                              electronic documents and electronic images of paper-based information captured through the
                              use of a document scanner. This software is a management solution that allows businesses to
                              control the production, storage, management, and distribution of electronic documents,
                              yielding greater effectiveness and the ability to reuse information and to control the flow
                              of the documents.
                            </p>
                            <p>
                              This software builds a highly valuable repository of corporate information assets to
                              facilitate knowledge creation and improve business decision-making, boosting workgroups and
                              enterprise productivity through shared practices, greater, better customer relations, faster
                              sales cycles, improved product time-to-market, and better-informed decision-making.
                            </p>
                          </div>
                        )}
...
export default CentralisedDocumentManagement;
