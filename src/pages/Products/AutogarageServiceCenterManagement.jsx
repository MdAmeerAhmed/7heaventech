...
function AutogarageServiceCenterManagement() {
    ...
    <div className="single-product-area" style={{ paddingTop: '50px' }}>
      ...
      <div className="container">
        <div className="product-bit-title text-center">
          <h2 style={{ color: '#000', paddingTop: '5px' }}>Autogarage Service Center Management</h2>
        </div>
        <div className="row">
          {/* Left Sidebar */}
          <div className="col-md-4">
            <div className="single-sidebar">
              ...
              <div className="single-sidebar">
                ...
                <ul>
                  <li>
                    <Link to="#">Why use software for Garages?</Link>
                  </li>
                  <li>
          ...
          <div className="col-md-8">
            <div className="product-content-right">
              <div className="product-breadcroumb">
                ...
                <Link to="#">Autogarage Service Center Management</Link>
              </div>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="product-images">
                    <div className="product-main-img">
                      <img src="img/product-8.jpg" alt="Main" />
                    </div>
                ...
                <div className="col-sm-6">
                  <div className="product-inner">
                    <h2 className="product-name">For Autogarage Work Management</h2>
                    <div className="product-inner-category">
                      <p>
                        Tags:{' '}
                        <Link to="#">Autogarage work management</Link>,{' '}
                      ...
                      <div className="tab-content">
                        {activeTab === 'home' && (
                          <div role="tabpanel" className="tab-pane active" id="home">
                            ...
                            <p>
                              This is a complete service center management solution aiming to ease the workload of
                              autogarages. Right from vehicle arrival for repair till delivery after works, every
                              workflow has been precisely defined. Built on a hi-tech platform, this software has a
                              proven record of task professionalism and customer satisfaction.
                            </p>
                            <p>
                              This will help you complete more jobs in minimal time, which will eventually increase
                              revenue, develop professionalism among your staff, increase customer satisfaction, and
...
export default AutogarageServiceCenterManagement;
