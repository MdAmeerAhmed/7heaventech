...
function PropertyBrokerManagement() {
    ...
    <div className="single-product-area" style={{ paddingTop: '50px' }}>
      ...
      <div className="container">
        <div className="product-bit-title text-center">
          <h2 style={{ color: '#000', paddingTop: '5px' }}>Property Broker Management</h2>
        </div>
        <div className="row">
          {/* Left Sidebar */}
          <div className="col-md-4">
            <div className="single-sidebar">
              ...
              <div className="single-sidebar">
                ...
                <ul>
                  <li>
                    <Link to="#">Why use a Brokerage management system?</Link>
                  </li>
                  <li>
          ...
          <div className="col-md-8">
            <div className="product-content-right">
              <div className="product-breadcroumb">
                ...
                <Link to="#">Property Broker Management</Link>
              </div>
                      ...
                      <div className="tab-content">
                        {activeTab === 'home' && (
                          <div role="tabpanel" className="tab-pane active" id="home">
                            ...
                            <p>
                              <strong>Close more deals in less time.</strong> The brokerage business is one of the
                              growing businesses in the market and the companies are looking for a medium that can
                              save operational time and cost and also bring brand awareness in the market. 7Heaven
                              Technology has introduced software specially for Brokerage Management which covers
                              every minor task of the brokerage system. With reminders to keep you alert and
                              preparing events and reports to let you monitor your performance and growth.
                            </p>
                            <p>
                              ...
                              performance of employees. You will also understand the market response and feedback
                              about your property.
                            </p>
                          </div>
                        )}
...
export default PropertyBrokerManagement;
